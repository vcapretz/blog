...
> If you want to follow along go to your terminal and hit `npx crna --template with-reanimated2` to start a branch new React Native project with Expo and Reanimated v2 installed.
